...
<p align="center">
  <b>AI 驱动的移动端智能输入平台</b><br>
  <span>语音润色 · 智能修改 · 智能写作 · 双拼 / T9 · 全键盘</span>
</p>
...
> **Cesia** 把「AI」做进了输入本身——说话、选中、改写，全程不用跳出当前 App。
...
| 离线可用 | 随时唤醒 | 免费 AI | 语音上屏 | 多布局 |
|:---:|:---:|:---:|:---:|:---:|
| 本地 Qwen 模型 + 离线语音识别，润色/改写/写作全都能跑 | 选中文字，一句话指令，AI 直接改写 | 支持 OpenRouter 免费模型，也支持自己配置任何兼容 API | 按住麦克风说大白话，润完直接进输入框 | Rime 引擎，全键盘、双拼、T9 九宫格随心切 |

---

## ⚡ 功能

| 智能修改 | 智能写作 | 快捷指令 | 语音命令 | 本地优先 |
|:---:|:---:|:---:|:---:|:---:|
| 选中文字，用一句话让 AI 改：翻译、换语气、扩写、缩句、去冗余 | 唤醒写作模式，AI 读剪贴板/浏览器/RSS/历史起稿，写周报、写邮件不再空白 | 管理自定义指令（置顶/增删/撤销），越用越顺手 | 说「写作」「魔法」「发送」等命令词，AI 直接执行 | 按键/剪贴板/润色历史全存本地；AI 请求走你自己的 Key |
